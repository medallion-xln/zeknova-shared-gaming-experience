...
- AlphaGo-inspired AZL strategic advisor: SCOUT-01 captures live colony telemetry and runs a browser-safe, six-expert policy through a depth-7 PUCT search of up to 320 simulations in a Web Worker. It returns ranked macro-actions and a projected sequence without controlling the player or spending resources. This is inference-only and heuristic-guided; it does not claim to be a trained AlphaZero neural network.
