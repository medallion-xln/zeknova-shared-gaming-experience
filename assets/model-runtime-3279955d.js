...
export async function loadJuggernautModel() {
  await MeshoptDecoder.ready;
  const [walkingGltf, runningGltf] = await Promise.all([
    loader.loadAsync('./assets/models/zeknovan-juggernaut-walk.glb'),
    loader.loadAsync('./assets/models/zeknovan-juggernaut-run.glb'),
  ]);
