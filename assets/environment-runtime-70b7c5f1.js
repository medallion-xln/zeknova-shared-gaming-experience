...
export function createAreaEnvironment({ areas, placements, heightAt, harvestableTrees = [], updateTreeInstance, onAssetLoaded }) {
  const root = new Group();
  ...
  return {
    ...
    update(playerPosition) {
      ...
      const refreshTreePools = treePoolMoved || now - lastTreePoolUpdateAt >= 350;
